...
<table class="table">
    ...
    <tr>
        ...
        <th scope="col">
            <fmt:message key="tracks.track.album"/>
        </th>
    </tr>
...
<div class="text-center">
    <c:forEach var="pageNo" begin="0" end="${requestScope.noOfPages}">
        <a href="${pageContext.request.contextPath}/frontController?frontCommand=all_tracks&pageNo=${pageNo}&offset=${20 * pageNo}"
           role="button"
